...
const writeExercise = async (req, res, next) => {
    ...
    let exercise = await Exercise.create({
        EX_Name,EX_KO_Name,EX_Description,EX_Creation_Date,EX_Update_Date
    });
  ...
  const writeReview = async (req,res,next) => {
    ...
    .then(
        ...
        if(obj) { // update
            ...
            return await E_evaluation.create({EEV_Writer_NickName,EEV_Rank,EEV_Content,Exercise_EX_Name,EEV_Creation_Date});
        }
    }
)
  // 운동의 평점과 관련된 정보 조회
