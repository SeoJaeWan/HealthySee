...
import { loggingExercise, increaseField } from "../../../modules/training/training"
...
const ExerciseForm = ({ history }) => {
  ...
  const gotResult = (error, results) => {
    console.log(results[0].label === poses[state], results[0].label, poses[state])
  ...
  return (
    <>
      ...
      />
      <ExerciseCom setup={setup} draw={draw} count={success_count} training={training} />
    </>
  )
}
